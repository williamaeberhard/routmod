# routnll_blockwise_eval_nolake: eval fn and gr of rounll_blockwise | v0.9
# * Change log:
#    - v0.9: initial version, forked from routnll_blockwise_eval v0.9

routnll_blockwise_eval_nolake <- function(parvec, predmat, maxlag, outputfitted=FALSE){
...
# end routnll_blockwise_eval_nolake
